#ifndef UNITY_DISK_KERNELS
#define UNITY_DISK_KERNELS

static const int kSampleRings_ultralow = 2;
static const int kSamplePointsRing_ultralow = 6;
static const int kSampleCount_ultralow = 7;
static const float2 kDiskKernel_ultralow[kSampleCount_ultralow] = {
    float2(0,0),
    float2(0,1),
    float2(0,-1),
    float2(-0.86602540,0.5),
    float2(-0.86602540,-0.5),
    float2(0.86602540,0.5),
    float2(0.86602540,-0.5),
};

static const int kSampleRings_low = 2;
static const int kSamplePointsRing_low = 5;
static const int kSampleCount_low = 16;
static const float2 kDiskKernel_low[kSampleCount_low] = {
    float2(0,0),
    float2(0.54545456,0),
...
static const int kSampleRings_medium = 3;
static const int kSamplePointsRing_medium = 7;
static const int kSampleCount_medium = 22;
static const float2 kDiskKernel_medium[kSampleCount_medium] = {
    float2(0,0),
    float2(0.53333336,0),
...
static const int kSampleRings_high = 4;
static const int kSamplePointsRing_high = 7;
static const int kSampleCount_high = 43;
static const float2 kDiskKernel_high[kSampleCount_high] = {
    float2(0,0),
    float2(0.36363637,0),
...
static const int kSampleRings_ultra = 5;
static const int kSamplePointsRing_ultra = 7;
static const int kSampleCount_ultra = 71;
static const float2 kDiskKernel_ultra[kSampleCount_ultra] = {
    float2(0,0),
    float2(0.2758621,0),
